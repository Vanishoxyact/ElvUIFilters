...
import main.java.com.purplefrog.jluadata.LuaParser.BlankIndex;
...
{
    public static String dumpAsLua(Map<Object, Object> db)
    {
        StringBuilder rval = new StringBuilder();
        for (Map.Entry<Object, Object> en : db.entrySet()) {
            Object key = en.getKey();
            Object value = en.getValue();
            if(key instanceof BlankIndex) {
                rval.append(dumpAsLua(value) + ",\n");
            } else {
                rval.append("[" + dumpAsLua(key) + "] = " + dumpAsLua(value) + ",\n");
            }
        }
