...
//            System.out.println(rval.size());
    ...
    private Object either(List<Object> listVersion, Map<Object, Object> mapVersion)
    {
        if (null != listVersion)
            return listVersion;
    ...
    public static class BlankIndex{}

    public static void appendBareValue(Map<Object, Object> mapVersion, int index, List<Object> listVersion, Object valueToAppend)
    {
        if (listVersion != null) {
            listVersion.add(valueToAppend);
        }

        mapVersion.put(new BlankIndex(), valueToAppend);
    }
        ...
        throws IOException, ParseException
    {
        while (true) {
            ...
            if (Character.isWhitespace(ch)) {
                ...
                Object rval = parseRemainingUnquotedString(ch);
                demandClosingSquareBracket();
                return rval;
            }
        }
    ...
    private Object parseRemainingUnquotedString(char firstChar)
        throws IOException, ParseException
    {
    ...
    public Map<String, Object> parseDictionary()
        throws IOException, ParseException
    {
        HashMap<String, Object> rval = new LinkedHashMap<String, Object>();
        ...
        while (true) {
            ...
            if (Character.isWhitespace(ch)) {
                ...
                String key = (String) parseRemainingUnquotedString(ch);
                eatEquals();
                Object value = parse();
